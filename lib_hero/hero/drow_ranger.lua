local hero_data = {
	"drow_ranger",
	{1, 3, 1, 3, 3, 4, 3, 1, 2, 1, 6, 4, 2, 2, 8, 2, 4, 9, 11},
	{
		"item_circlet","item_slippers","item_tango","item_branches","item_branches","item_quelling_blade","item_branches","item_gloves","item_wraith_band","item_boots","item_boots_of_elves","item_power_treads","item_blades_of_attack","item_fluffy_hat","item_falcon_blade","item_blade_of_alacrity","item_dragon_lance","item_boots_of_elves","item_aghanims_shard","item_yasha","item_manta","item_force_staff","item_hurricane_pike","item_black_king_bar","item_blink","item_ultimate_orb","item_pers","item_sphere","item_eagle","item_swift_blink","item_boots","item_refresher","item_rapier","item_rapier",
	},
