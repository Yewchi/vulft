local hero_data = {
	...
	{
		"item_magic_stick","item_tango","item_ward_dispenser","item_ring_of_regen","item_clarity","item_ward_dispenser","item_wind_lace","item_boots","item_tranquil_boots","item_magic_wand","item_fluffy_hat","item_fluffy_hat","item_wind_lace","item_void_stone","item_cyclone","item_blink","item_staff_of_wizardry","item_crown","item_dagon_5","item_dagon_2L",
	},
	{ {3,3,3,1,1,}, {4,4,4,5,5,}, 0.1 },
	{
		"Impale","Mana Burn","Spiked Carapace","Vendetta","+8% Spell Amplification","+0.25s Impale Stun Duration","+250 Health","+0.5x Mana Burn Intelligence Multiplier","+0.6s Spiked Carapace Stun Duration","+130 Impale Damage","+300 Mana Burn Radius","Vendetta Unobstructed Pathing",
	}
}
