local hero_data = {
	"bloodseeker",
	{2, 3, 3, 1, 3, 5, 3, 1, 1, 1, 6, 5, 2, 2, 8, 2, 5, 10, 12},
	{
		"item_quelling_blade","item_tango","item_slippers","item_circlet","item_branches","item_branches","item_wraith_band","item_boots","item_blades_of_attack","item_chainmail","item_phase_boots","item_javelin","item_mithril_hammer","item_maelstrom","item_ogre_axe","item_mithril_hammer","item_black_king_bar","item_magic_wand","item_ultimate_orb","item_pers","item_sphere","item_basher","item_hyperstone","item_mjollnir","item_reaver","item_satanic",
	},
