...
d = {
	...
	["AbilityThink"] = function(gsiPlayer) 
		...
		--[[DEV]]--print("Lina lsa range", lsa.GetAOERadius and lsa:GetAOERadius())
...
--[[DEV]]		print(CAN_BE_CAST(gsiPlayer, langua),
--[[DEV]]				fhtReal, langua:GetName(),
--[[DEV]]					gsiPlayer.lastSeenMana > langua:GetManaCost(),
--[[DEV]]					fhtReal and AbilityLogic_AllowOneHitKill(
--[[DEV]]						gsiPlayer,
--[[DEV]]						fht,
--[[DEV]]						langua:GetCastRange(),
--[[DEV]]						langua:GetSpecialValueInt("damage"),
--[[DEV]]						langua:GetDamageType()
--[[DEV]]					))
