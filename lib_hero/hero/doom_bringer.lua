...
d = {
	...
	["AbilityThink"] = function(gsiPlayer) 
		...
		--[[DEV]]if DEBUG then print("doom neutrals", acquired1) end
		if acquired1 then
			--[[DEV]]if DEBUG then print(acquired1:GetName()) end
			local neutralsTarget = DETECT_NEUTRALS_ABILITY(gsiPlayer, acquired1)
			--[[DEV]]if DEBUG then print(Util_Printable(neutralsTarget), HIGH_USE(gsiPlayer, acquired1, highUse*1.5, playerHpp)) end
		...
		--[[DEV]]if DEBUG then print("doom", acquired2) end
		if acquired2 then
