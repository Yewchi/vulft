local hero_data = {
	"omniknight",
	{3, 2, 2, 1, 2, 1, 2, 4, 1, 5, 1, 4, 3, 3, 8, 3, 4, 9},
	{
		"item_magic_stick","item_tango","item_enchanted_mango","item_branches","item_enchanted_mango","item_ward_sentry","item_boots","item_magic_wand","item_magic_wand","item_headdress","item_fluffy_hat","item_energy_booster","item_arcane_boots","item_headdress","item_holy_locket","item_arcane_boots","item_buckler","item_ring_of_basilius","item_lifesteal","item_blades_of_attack","item_vladmir","item_wraith_pact",
	},
