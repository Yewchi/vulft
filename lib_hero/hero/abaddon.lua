local hero_data = {
	"abaddon",
	{2, 1, 2, 2, 1, 4, 2, 1, 1, 3, 6, 4, 3, 3, 8, 3, 4, 9, 12},
	{
		"item_tango","item_enchanted_mango","item_enchanted_mango","item_clarity","item_clarity","item_flask","item_tango","item_branches","item_boots","item_tranquil_boots","item_magic_wand","item_void_stone","item_energy_booster","item_aether_lens","item_lifesteal","item_ring_of_basilius","item_buckler","item_blades_of_attack","item_vladmir","(null)","item_pers","item_platemail","item_lotus_orb",
	},
	{ {1,1,1,1,1,}, {5,5,5,5,5,}, 0.1 },
	{
		"Mist Coil","Aphotic Shield","Curse of Avernus","Borrowed Time","+15 Movement Speed","+8 Strength","+65 Damage","+50 Mist Coil Heal/Damage","+100 Aphotic Shield Health","-8s Borrowed Time Cooldown","-1 Curse of Avernus Attacks Required","+400 AoE Mist Coil",
	}
}
