local hero_data = {
	"silencer",
	{2, 1, 2, 1, 1, 4, 1, 3, 3, 3, 3, 4, 2, 2, 7, 5, 4, 9, 11},
	{
		"item_tango","item_branches","item_mantle","item_circlet","item_circlet","item_gloves","item_boots","item_robe","item_power_treads","item_null_talisman","item_null_talisman","item_wind_lace","item_blitz_knuckles","item_robe","item_chainmail","item_witch_blade","item_staff_of_wizardry","item_fluffy_hat","item_force_staff","item_hurricane_pike","item_aghanims_shard","item_shadow_amulet","item_blitz_knuckles","item_invis_sword","item_mystic_staff","item_ultimate_orb","item_sheepstick","item_lesser_crit","item_silver_edge","item_gem","item_black_king_bar",
	},
	{ {1,1,1,5,3,}, {4,4,1,5,5,}, 0.1 },
	{
