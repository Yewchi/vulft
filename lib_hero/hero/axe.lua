local hero_data = {
	...
	{
		"Berserker's Call","Battle Hunger","Counter Helix","Culling Blade","+8 Berserker's Call Armor","+10% Movement Speed per active Battle Hunger","-12% Battle Hunger Slow","+30 Counter Helix Damage","+150 Culling Blade Damage","+1 Bonus Armor per Culling Blade Stack","+100 Berserker's Call AoE","x2x Battle Hunger Armor Multiplier",
	}
}
