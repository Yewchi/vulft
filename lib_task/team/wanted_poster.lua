...
function WP_AllocateToHighestScores(wpHandle, ignorePower)
	...
	while(true) do
		...
		if currHighIndex > TEAM_NUMBER_OF_PLAYERS then print(currObjectivePowerLevel, objectivePowerLevel, posterTotalScore, currTaskTotalScore) set_next_try_alloc_allowed(wpHandle) break; end
